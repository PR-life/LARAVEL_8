...
@push('svg')
<symbol id="svg-web" fill='currentColor' viewBox="0 0 496 512">
...
<div class="Box Edge -SPC edge-s / void">

    {{-- <div class="content">личный пиар</div> --}}


 

    @include('UTIN._lego.intro')
    ...
    {{-- @include('UTIN._lego.plot_3',['css' => '-Black Black -bg / space-m']) --}}
...
@component('UTIN._wrap.Font')
    @slot('name','Ad aute sunt veniam reprehenderit')
    <div class="_p Grey / Blog">Deserunt sunt labore amet irure amet aliquip voluptate ipsum. Velit laboris nisi enim duis culpa tempor ut nisia.</div>
@endcomponent
@endslot

 

 <div class="Abs -all / flex">

    <div class="flex cross-xxs">
        <div class="round-m space bg-blue">
            <div class="h">Magna Lorem aliquip tempor duis proident</div>
