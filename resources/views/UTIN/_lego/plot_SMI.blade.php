        ...
        <div class="_body / Details -edge">
            ...
            <details>
                ...
                <div class="_edge void net">
                    ...
                    <div class="content / net">Попасть в авторский, когда редакторы сами связываются с экспертом.</div>                    
            ...
            <details>
                ...
                <div class="_edge void net">
                    ...
                    <div class="content / net">В эту категорию попадают "Новые медиа", региональные СМИ и прочие площадки для публикации статей.</div>
    ...
    <div class="_r round-m space / bg-blueFon">
            ...
            <div class="void">
                <ul class="-service ul -S">
                    <li>ищем запросы от журналистов (<span class="a" data-click data-goto='milk_smiAnswer' data-foo='click'>подробнее</span>)</li>
                ...
                <div class="Citation -M -left -mbl -mblPC">
                    <div class="_right">
                    <div class="content content-m wide round-s">Устанавливаем и поддерживаем контакты с журналистами и редакторами для обеспечения видимости медицинских инициатив и экспертного мнения.</div>
