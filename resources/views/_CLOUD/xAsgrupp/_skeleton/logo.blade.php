<div id="wrapLogoGoo" class="none_mbl">
    <div id="Logo" class="Abs -lt / LOGO / _indexMax op">
        <div class="flex cC cI / Header -h">
            ...
            <div id="btnMenuBeyond" class="x-spaceBurger pointer / none Beyond" data-click data-node='body' data-css data-toggle='beyondOpen -veil fix' data-veil="btnMenuBeyond">
