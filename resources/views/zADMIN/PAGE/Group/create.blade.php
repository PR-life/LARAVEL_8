...
@section('title')New. Group @endsection
...
<div class="I aura">
	...
	@component('zADMIN.PAGE._wrap.form.create', ['route' => route('admin.group.store'), 'css' => '-group'])

		@include('zADMIN._brick.bar.v.create', ['route' => route('admin.group.index')])


		<div class="_shell _name / vol-Abs">
			<input id="name" type="text" name="name" value="{{old('name')}}" placeholder='.'>
			<label class="Abs" for="name">Имя группы</label>
			@error('name')
