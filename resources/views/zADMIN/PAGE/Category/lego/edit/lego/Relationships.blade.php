            ...
            <div class="Min -w5">
                ...
                <div class="wrap-relationship -multiple">
                    @component('zADMIN._wrap.select.services.index', ['id' => 'services'])
                        @include('_._brick.select.services.edit.index',['Services' => $services, 'arr' => $category->services->pluck('id')->toArray()])
                    @endcomponent
                </div>
            </div>
        </div>
    ...
    @component('zADMIN._wrap.Relationships.line')
        ...
        <div class="W-100 / Grid x3 -gap">
            ...
            <div class="void">
                ...
                <div class="wrap-relationship -solo / round">
                    @include('zADMIN._wrap.select.name',['Var' => 'Услуги из категории'])
            ...
            <div class="void">
                ...
                <div class="wrap-relationship -solo / round">
                    ...
                    @component('zADMIN._wrap.select.paper.index', ['id' => 'paper_payment_id','name'=>'paper_payment_id'])
                        @include('_._brick.select.paper.edit.index',['Papers' => $papers, 'Var' => $category->paper_payment_id])
                    @endcomponent
                </div>
                <div class="wrap-relationship -solo / round">
                    ...
                    @component('zADMIN._wrap.select.paper.index', ['id' => 'paper_warranty_id','name'=>'paper_warranty_id'])
                        @include('_._brick.select.paper.edit.index',['Papers' => $papers, 'Var' => $category->paper_warranty_id])
                    @endcomponent
                </div>
            </div>
        </div>
