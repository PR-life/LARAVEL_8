<form class="Form -L -shadow" method="POST" action="{{route('sms.store')}}" enctype="multipart/form-data">
	@csrf
	<div id="scrolSmsError"></div>

	<a id="sms" class="Anchor"></a>
	<input id="title" class="none" type="text" name="title" value="." placeholder='.'>
	<input id="from_page" class="none" type="text" name="from_page" value="{{url()->current()}}" placeholder='.'>
