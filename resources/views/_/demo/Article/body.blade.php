...
@include('_.demo.text.img.floatR')
...
<div class="_dl text">
    @include('_.demo.contacts.minDl',['css' => 'net'])
    @include('_.demo.contacts.minChatDl',['css' => 'net'])
</div>
...
@include('_.demo.text.blockquote.index')
