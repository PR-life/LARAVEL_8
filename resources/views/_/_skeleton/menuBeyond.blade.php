...
<div class="none / blockZ2-Beyond">
    <div class="Ico -M / space contentBox"></div>
    <div class="Header -h"></div>
</div>

<div id="btnMenuMilkClose" class="Fix Abs -lt / space-m / none">
    <label for="inputMenuMain" class="_btn / Ico -S / flex cC cI">
        @svg('close')
    </label>
</div>
