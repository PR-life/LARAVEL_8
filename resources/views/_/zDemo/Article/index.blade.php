<article class="text Edge {{$css ?? ''}}">
	...
	<div class="_100 _text">
		<figure>
			<picture>
				<img src="https://imperavi.com/assets/article/articles/img/article-01-1.jpg">
			</picture>
			<figcaption class="-b -edge center">Quae fuerit causa, nollem me tamen laudandis maioribus meis corrupisti.</figcaption>
		</figure>
	</div>

	<p>In oculis quidem rerum hic tenetur a philosophis compluribus permulta dicantur, cur nec segniorem ad modum, quaeso, interpretaris? sicine eos et dolore suo sanciret militaris imperii disciplinam exercitumque in liberos atque insitam in liberos atque in liberos atque insitam in malis dolor, non provident, similique.</p>

	<h2>In oculis quidem exercitus</h2>


	<div class="_p _edge / text">
		<figure class="float-right Max">
			<img src="https://imperavi.com/assets/article/articles/img/article-01-2.jpg">
			<figcaption class="-b">Certe, inquam, pertinax non intellegamus</figcaption>
		</figure>
		<p>Sed ut de commodis suis cogitarent? at id omnia referri oporteat, ipsum per se esse ratione intellegi posse et expedita distinctio nam libero tempore, cum a natura incorrupte atque integre iudicante itaque earum motus et impetus quo pertineant non possim accommodare torquatos nostros? quos dolores.</p>
