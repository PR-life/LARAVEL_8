...
Route::group(['namespace' => 'ADMIN','middleware' => ['auth','admin','verified']], function () {
    Route::group(['namespace' => '_CRM'], function(){

        // Route::get('/', function() {return 'crm';})->name('admin.crm.face.index');
        ...
        Route::group(['namespace' => 'Face', 'prefix' => 'face'], function(){
            ...
            Route::delete('/{face}', 'DeleteController')->name('crm.face.delete');
        });
        ...
        Route::group(['namespace' => 'Customer', 'prefix' => 'customers'], function(){
            ...
            //     Route::get('/', function() {return view('zADMIN.PAGE.zCRM.Customer.CATEGORY');})->name('customer.category.index');
            // });
            // Route::group(['namespace' => 'Discount', 'prefix' => 'discounts'], function(){
            //     Route::get('/', function() {return view('zADMIN.PAGE.zCRM.Customer.DISCOUNT');})->name('customer.discount.index');
            // });
        });
